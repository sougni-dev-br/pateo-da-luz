...
const UNIDADE_FRACIONADA = /^(KG|KGS|G|GR|GRAMA|GRAMAS|L|LT|LTS|LITRO|LITROS|ML)$/i;

export function unitAcceptsDecimal(unit: string | null | undefined) {
  return UNIDADE_FRACIONADA.test(String(unit ?? "").trim());
}
